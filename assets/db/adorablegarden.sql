...
INSERT INTO `tbl_binh_luan` (`id`, `ho_ten`, `tai_khoan`, `noi_dung`, `ngay_tao`, `id_tin_tuc`) VALUES
(0, 'Nguyễn  Hoàng Ngân', 'hoangngan6298@gmail.com', 'fdsafds', '2020-04-29 04:00:46', 1);
...
CREATE TABLE `tbl_danh_gia` (
  ...
  `loai_danh_gia_id` int(11) NOT NULL,
...
INSERT INTO `tbl_danh_gia` (`id`, `ho_ten`, `noi_dung`, `diem`, `loai_danh_gia_id`, `id_nv`) VALUES
(1, 'Chu Huệ Mẫn', 'vcnb', 2, 2, 1),
(2, 'cxccc', 'cxzcx', 6, 3, 4);
...
(23, 1, '2020-04-28 17:00:00', ''),
(24, 1012, '2020-04-28 17:00:00', ''),
(25, 1012, '2020-04-28 17:00:00', ''),
(26, 1012, '2020-04-28 17:00:00', ''),
(27, 1012, '2020-04-28 17:00:00', ''),
(28, 1012, '2020-04-28 17:00:00', ''),
(29, 1012, '2020-04-28 17:00:00', ''),
(30, 1012, '2020-04-28 17:00:00', ''),
(31, 1012, '2020-04-28 17:00:00', ''),
(32, 1012, '2020-04-28 17:00:00', ''),
(33, 1012, '2020-04-28 17:00:00', ''),
(34, 1012, '2020-04-28 17:00:00', ''),
(35, 1012, '2020-04-28 17:00:00', ''),
(36, 1012, '2020-04-28 17:00:00', ''),
(37, 1012, '2020-04-28 17:00:00', ''),
(38, 1012, '2020-04-28 17:00:00', '');
...
--
-- Table structure for table `tbl_loai_danh_gia`
--

CREATE TABLE `tbl_loai_danh_gia` (
  `id` int(11) NOT NULL,
  `ten_loai_danh_gia` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_loai_danh_gia`
--

INSERT INTO `tbl_loai_danh_gia` (`id`, `ten_loai_danh_gia`) VALUES
(1, 'Chất lượng'),
(2, 'Tốc độ'),
(3, 'Thái độ phục vụ'),
(4, 'Giá cả');
...
(1238, 'manchu@gmail.com', 'admin@123', 'admin'),
...
(11, 'Chu Huệ Mẫn', 'ghjghjn', 'manchu@gmail.com', '2020-04-29 04:16:41', 'fdsfd');
...
CREATE TABLE `tbl_tin_tuc` (
  ...
  `noi_dung_3` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `tbl_danh_gia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `loai_danh_gia_id` (`loai_danh_gia_id`),
  ADD KEY `id_nv` (`id_nv`);
...
--
-- Indexes for table `tbl_loai_danh_gia`
--
ALTER TABLE `tbl_loai_danh_gia`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_loai_danh_gia`
--
ALTER TABLE `tbl_loai_danh_gia`
...
--
ALTER TABLE `tbl_binh_luan`
  ADD CONSTRAINT `FK_tbl_binh_luan_tbl_khach_hang` FOREIGN KEY (`tai_khoan`) REFERENCES `tbl_khach_hang` (`email`) ON DELETE NO ACTION ON UPDATE CASCADE;
