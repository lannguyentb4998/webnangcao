            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                     ...
                     <form method="POST" action="<?=base_url().'admin/quan_tri_khach_hang/thuc_hien_them_moi_khach_hang';?>">
                        <div class="card-body ">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" class="form-control" name="txtGioiTinh" placeholder="Giới tính">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col m-b-30">
                            ...
                            <div class="form-group">
                                <button class="btn btn-warning">Thêm khách hàng</button>
                            </div>
                        </div>
                    </div>
                    <!--widget card ends-->
