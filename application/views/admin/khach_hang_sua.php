            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class="">  SỬA THÔNG TIN KHÁCH HÀNG
                        </h4>
                        <p class="opacity-75 ">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form method="POST" action="<?=base_url().'admin/quan_tri_khach_hang/thuc_hien_sua_khach_hang';?>">
                        <div class="card-body ">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="txtHoTen">Họ và tên</label>
                                    <input type="text" class="form-control" name="txtHoTen" placeholder="Họ tên" value="<?=$khach_hang->ten_kh;?>">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="txtEmail">Email</label>
                                    <input type="email" class="form-control" name="txtEmail" placeholder="Email" value="<?=$khach_hang->email;?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col m-b-30">
                                    <label for="txtSDT">Số điện thoại</label>
                                    <input type="text" class="form-control" name="txtSDT" placeholder="SĐT" value="<?=$khach_hang->SDT;?>" >
                                </div>
                                <div class="form-group col m-b-30">
                                <label for="txtNgaySinh">Ngày sinh</label>
                                <input type="Date" class="form-control" name="txtNgaySinh" placeholder="Ngày sinh" value="<?=$khach_hang->ngaysinh;?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col m-b-12">
                                <label for="txtGioiTinh">Giới tính</label>
                                <input type="text" class="form-control" name="txtGioiTinh" placeholder="Giới tính" value="<?=$khach_hang->gioi_tinh;?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col m-b-30">
                                    <label for="txtQuan">Quận</label>
                                    <input type="text" class="form-control" name="txtQuan"  placeholder="Quận" value="<?=$khach_hang->quan;?>">
                                </div>
                                <div class="form-group col m-b-30">
                                    <label for="txtThanhPho">Thành phố</label>
                                    <input type="text" class="form-control" name="txtThanhPho" placeholder="Thành phố" value="<?=$khach_hang->thanh_pho;?>">

                                </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-warning">Sửa khách hàng</button>
                                <input name="txtID" type="hidden" value="<?=$khach_hang->id;?>">
                            </div>
                        </div>
                    </div>
                    <!--widget card ends-->
                            ...
                            <div class="form-group" >
                                <label for="txtAnhMinhHoa">Ảnh minh họa </label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="txtAnhMinhHoa" value="<?=$khach_hang->anh_minh_hoa;?>">
