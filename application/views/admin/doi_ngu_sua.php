                        ...
                        <div class="card-body ">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="txtHoTen" placeholder="Họ tên" value="<?=$doi_ngu->ten_nv;?>">
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col m-b-30">
                                    ...
                                    <input type="text" class="form-control" name="txtGia" placeholder="Giá dịch vụ" value="<?=$doi_ngu->don_gia;?>">
