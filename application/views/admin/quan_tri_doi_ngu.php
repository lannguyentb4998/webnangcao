            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-8 m-auto text-white p-b-30">
                        ...
                        <h1> QUẢN TRỊ ĐỘI NGŨ</h1>
                        <p class="opacity-75">
                            Đội ngũ nhân viên chăm sóc vườn và giá dịch vụ tương ứng
                        </p>
                    ...
                    <div class="col-md-4 m-auto text-white p-b-30">
                        <div class="text-md-right">
                            <a href="<?=base_url();?>admin/quan_tri_doi_ngu/them_moi_doi_ngu" class="btn btn-warning"> <i class="mdi mdi-plus"></i> Thêm nhân viên</a>
                    ...
                    <div class="card mb-3">
                        <div class="card-header border-bottom">
                            <div class="row no-gutters align-items-center">
                                <div class="col font-weight-bold">Danh sách nhân viên</div>
                                <div class="d-none d-md-block col-8 text-muted">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-1 col font-weight-bold">Tuổi</div>
                                        <div class="col-2 col font-weight-bold">Đơn giá (/giờ)</div>
                                        <div class="col-7 col font-weight-bold">Giới thiệu</div>
                                        <div class="col-2 col font-weight-bold">Tùy chọn</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-7 align-items-center">
                                            ...
                                            <div class="media-body  ml-2">
                                                <a href='doi_ngu_sua' class='d-block '><?=$row->gioi_thieu;?> </a>
                                                <div class="text-muted small "> <a href='khach_hang_sua' class='text-muted'></a></div>
                                                </div>
                                            </div>                                        
                                            <div class = "col-2" class="text-md-right">
                                                <a href="<?=base_url();?>admin/quan_tri_doi_ngu/sua_doi_ngu/<?=$row->id;?>" class="btn btn-warning"> <i class="mdi mdi-pencil"></i></a>
                                                <a href="<?=base_url();?>admin/quan_tri_doi_ngu/xoa_doi_ngu/<?=$row->id;?>" class="btn btn-warning"> <i class="mdi mdi-delete"></i></a>
                                            </div>    
                                        </div>                
                                    </div>
                                </div>
