            ...
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
              <tr>
                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#ffffff;"> Xác nhận đăng ký </div>
                </td>
              </tr>
            </table>
          </div>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:32px;font-weight:light;line-height:24px;text-align:center;color:#503d21;">
                                  <h1 style="line-height:1.3;font-size:32px;font-weight:100;margin-bottom:1px;"> Chỉ cần một bước nữa là bạn đăng ký thành công </h1>
                                </div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;font-weight:400;line-height:24px;text-align:center;color:#637381;"> Nếu bạn không tạo được tài khoản, hãy liên hệ với chúng tôi <a href="" style="color:#687ae8">adorablegarden@gmail.com</a> </div>
                              </td>
                            </tr>
                          </table>
                        </td>
