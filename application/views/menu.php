                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta d-flex">
                                ...
                                <div class="login">
                                    <a href="admin/dang_nhap"><i class="fa fa-user" aria-hidden="true"></i> <span>Đăng nhập</span></a>
                                </div>
                                
                                <div class="cart">
                                    <a href="gio_hang"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Giỏ hàng <span class="cart-quantity"></span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
